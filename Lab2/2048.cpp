...
public:
	...
	void make_statistic(size_t n, const board& b, int score, int unit = 1000) {
		...
		if (n % unit == 0) { // show the training process
			...
			info << "\t" "max = " << max;
			info << std::endl;
			// std::ofstream myfile ("./scores/dynamic_alpha2.txt", std::ios_base::app);
			// if (myfile.is_open()){
			// 	myfile << mean << "\n";
			// }
...
int main(int argc, const char* argv[]) {
	...
	tdl.load("./weights/dynamic_alpha/w_1500000");
	...
	for (size_t n = 1; n <= total; n++) {
		...
		if(n > 500000 && flag1 == 0){
			std::cout << "hello";
			alpha = 0.025;
			tdl.save("./weights/dynamic_alpha/w_500000");
			flag1 = 1;
		}
		else if(n > 1000000 && flag2 == 0){
			alpha = 0.0125;
			tdl.save("./weights/dynamic_alpha/w_1000000");
			flag2 = 1;
		}
		else if(n > 1500000 && flag3 == 0){
			alpha = 0.0625;
			tdl.save("./weights/dynamic_alpha/w_1500000");
			flag3 = 1;
		}
	...
	tdl.save("./weights/dynamic_alpha/w_2000000");
